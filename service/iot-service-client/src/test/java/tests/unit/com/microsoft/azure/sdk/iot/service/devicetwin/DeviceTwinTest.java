...
public class DeviceTwinTest
{
     ...
     */
    @Test
    public void constructorCreatesTwin(@Mocked IotHubConnectionStringBuilder mockedConnectionStringBuilder, @Mocked DeviceTwinDevice mockedDevice) throws Exception
    {
        //arrange
