...
public class DeviceMethodCommon extends MethodNameLoggingIntegrationTest
{
    ...
    private DeviceMethodCommon.DeviceMethodITRunner testInstance;

    public DeviceMethodCommon(DeviceTestManager deviceTestManager, IotHubClientProtocol protocol, AuthenticationType authenticationType, String clientType, Device device, Module module)
    {
        super();
    ...
    public void invokeMethodRecoveredFromAmqpsMethodReqLinkDrop() throws Exception
    {
        ...
        this.errorInjectionTestFlow(ErrorInjectionHelper.amqpsMethodRespLinkDropErrorInjectionMessage(ErrorInjectionHelper.DefaultDelayInSec, ErrorInjectionHelper.DefaultDurationInSec));
    }
    ...
    public void invokeMethodRecoveredFromAmqpsTwinReqLinkDrop() throws Exception
    {
        ...
        this.errorInjectionTestFlow(ErrorInjectionHelper.amqpsTwinReqLinkDropErrorInjectionMessage(ErrorInjectionHelper.DefaultDelayInSec, ErrorInjectionHelper.DefaultDurationInSec));
    }
    ...
    public void invokeMethodRecoveredFromAmqpsTwinRespLinkDrop() throws Exception
    {
        ...
        this.errorInjectionTestFlow(ErrorInjectionHelper.amqpsTwinRespLinkDropErrorInjectionMessage(ErrorInjectionHelper.DefaultDelayInSec, ErrorInjectionHelper.DefaultDurationInSec));
    }
    ...
    private void errorInjectionTestFlow(Message errorInjectionMessage) throws Exception
    {
        ...
        this.testInstance.deviceTestManager.sendMessageAndWaitForResponse(errorInjectionMsgAndRet, RETRY_MILLISECONDS, SEND_TIMEOUT_MILLISECONDS, this.testInstance.protocol);
