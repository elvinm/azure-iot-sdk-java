...
public class SasTokenGenerator
{
     ...
     */
    public static String generateSasTokenForIotDevice(String hostname, String deviceId, String devicePrimaryKey, long secondsUntilExpiration) throws InvalidKeyException
    {
        ...
        String token = String.format("HostName=%s;DeviceId=%s;SharedAccessSignature=SharedAccessSignature sig=%s&se=%s&sr=%s", hostname, deviceId, signature, String.valueOf(tokenExpirationTime), deviceUri);
     ...
     */
    private static String getSignature(String resourceUri, long expiryTime, String devicePrimaryKey) throws InvalidKeyException
    {
        try
        {
     ...
     */
    private static byte[] encryptHmacSha256(byte[] textToSign, byte[] key) throws NoSuchAlgorithmException, InvalidKeyException
    {
