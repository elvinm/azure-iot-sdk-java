...
public class AmqpsDeviceTwinTest
{
    ...
    @Test
    public void iotHubMessageToProtonMessageSetAnnotationsForUpdateReportedPropertiesRequest(@Mocked final IotHubTransportMessage mockedIotHubTransportMessage)
    {
        // arrange
        AmqpsDeviceTwin amqpsDeviceTwin = Deencapsulation.newInstance(AmqpsDeviceTwin.class, mockDeviceClientConfig);
    ...
    @Test
    public void iotHubMessageToProtonMessageSetAnnotationsForSubscribeDesiredProperties(@Mocked final IotHubTransportMessage mockedIotHubTransportMessage)
    {
        // arrange
        AmqpsDeviceTwin amqpsDeviceTwin = Deencapsulation.newInstance(AmqpsDeviceTwin.class, mockDeviceClientConfig);
        final MessageProperty[] messageProperties = new MessageProperty[]{};
    ...
    @Test
    public void iotHubMessageToProtonMessageSetAnnotationsForUnsubscribeDesiredProperties(@Mocked final IotHubTransportMessage mockedIotHubTransportMessage)
    {
        // arrange
        AmqpsDeviceTwin amqpsDeviceTwin = Deencapsulation.newInstance(AmqpsDeviceTwin.class, mockDeviceClientConfig);
        final MessageProperty[] messageProperties = new MessageProperty[]{};
    ...
    public void iotHubMessageToProtonMessageThrowsIfVersionIsNotLong(@Mocked final IotHubTransportMessage mockedIotHubTransportMessage)
    {
        // arrange
        AmqpsDeviceTwin amqpsDeviceTwin = Deencapsulation.newInstance(AmqpsDeviceTwin.class, mockDeviceClientConfig);
        final MessageProperty[] messageProperties = new MessageProperty[]{};
