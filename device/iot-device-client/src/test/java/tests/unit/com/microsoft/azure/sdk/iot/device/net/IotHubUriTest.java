...
public class IotHubUriTest
{
    ...
    public void shortConstructorHasCorrectFormat()
    {
        ...
        final String expectedUriStr = "sample.iothubhostname/devices/sample-deviceid/sample-path?" + API_VERSION;
    ...
    public void toStringWithoutApiVersionSuccess()
    {
        ...
        final String expectedUriStr = "sample.iothubhostname/devices/sample-deviceid/sample-path";
        assertThat(testUriStr, is(expectedUriStr));
    }
    ...
    public void shortConstructorUrlEncodesDeviceId()
    {
        ...
        final String expectedUriStr = "sample.iothubhostname/devices/%3F%26sample-deviceid/sample-path?" + API_VERSION;
        assertThat(testUriStr, is(expectedUriStr));
    }
    ...
    public void shortConstructorUrlEncodesIotHubMethodPath()
    {
        ...
        final String expectedUriStr = "sample.iothubhostname/devices/sample-deviceid/sample-path%3F?" + API_VERSION;
        assertThat(testUriStr, is(expectedUriStr));
    }
    ...
    public void constructorWithQueryFragmentHasCorrectFormat()
    {
        ...
        IotHubUri uri = new IotHubUri(iotHubHostname, deviceId, iotHubMethodPath, queryParams, "");
        String testUriStr = uri.toString();

        final String expectedUriStr0 = "sample.iothubhostname/devices/sample-deviceid/sample-path?test=true&?" + API_VERSION;
        final String expectedUriStr1 = "sample.iothubhostname/devices/sample-deviceid/sample-path?" + API_VERSION + "&test=true";
    ...
    public void constructorUrlEncodesQueryParams()
    {
        ...
        final String expectedUriStr0 = "sample.iothubhostname/devices/sample-deviceid/sample-path?test%3F=true%3F&?" + API_VERSION;
        final String expectedUriStr1 = "sample.iothubhostname/devices/sample-deviceid/sample-path?" + API_VERSION + "&test%3F=true%3F";
        assertThat(testUriStr, is(anyOf(equalTo(expectedUriStr0), equalTo(expectedUriStr1))));
    }
    ...
    public void getResourceUriHasCorrectFormat()
    {
        ...
        final String expectedResourceUri = "sample.iothubhostname/devices/sample-deviceid";
    ...
    public void getResourceUriUrlEncodesDeviceId()
    {
        ...
        final String expectedResourceUri = "sample.iothubhostname/devices/sample-deviceid%3F";
        assertThat(testResourceUri, is(expectedResourceUri));
    }
    ...
    public void getHostnameReturnsHostname()
    {
        ...
        final String expectedHostname = "sample.iothubhostname";
