...
import com.microsoft.azure.sdk.iot.provisioning.service.EnrollmentGroupManager;
...
public class EnrollmentGroupManagerTest
{
    ...
    {
        return Deencapsulation.invoke(EnrollmentGroupManager.class, "createFromContractApiHttp", new Class[]{ContractApiHttp.class}, mockedContractApiHttp);
    ...
    public void factoryCreatesNewInstanceSucceed()
    {
        // arrange
        // act
        EnrollmentGroupManager enrollmentGroupManager = Deencapsulation.invoke(EnrollmentGroupManager.class, "createFromContractApiHttp", new Class[]{ContractApiHttp.class}, mockedContractApiHttp);
    ...
    @Test
    public void createOrUpdateRequestSucceed(@Mocked final EnrollmentGroup mockedEnrollmentGroup, @Mocked final EnrollmentGroup mockedEnrollmentGroupResponse) throws ProvisioningServiceClientException
    {
        // arrange
    ...
    /* SRS_ENROLLMENT_GROUP_MANAGER_21_045: [If the enrollmentGroup contains eTag, the createOrUpdate shall send a Http request with `If-Match` the eTag in the header.] */
    @Test
    public void createOrUpdateRequestWithEtagSucceed(@Mocked final EnrollmentGroup mockedEnrollmentGroup, @Mocked final EnrollmentGroup mockedEnrollmentGroupResponse) throws ProvisioningServiceClientException
    {
        // arrange
        final String enrollmentGroupId = "enrollmentGroupId-1";
        final String enrollmentGroupPath = "enrollmentGroups/" + enrollmentGroupId;
    ...
    public void createOrUpdateRequestTrowsOnNullBody(@Mocked final EnrollmentGroup mockedEnrollmentGroup) throws ProvisioningServiceClientException
    {
        // arrange
        final String enrollmentGroupId = "enrollmentGroupId-1";
        final String enrollmentGroupPath = "enrollmentGroups/" + enrollmentGroupId;
    ...
    public void createOrUpdateRequestTransportFailed(@Mocked final EnrollmentGroup mockedEnrollmentGroup) throws ProvisioningServiceClientException
    {
        // arrange
        final String enrollmentGroupId = "enrollmentGroupId-1";
        final String enrollmentGroupPath = "enrollmentGroups/" + enrollmentGroupId;
    ...
    public void createOrUpdateServiceReportedFail(@Mocked final EnrollmentGroup mockedEnrollmentGroup) throws ProvisioningServiceClientException
    {
        // arrange
        final String enrollmentGroupId = "enrollmentGroupId-1";
        final String enrollmentGroupPath = "enrollmentGroups/" + enrollmentGroupId;
    ...
    @Test
    public void getRequestSucceed(@Mocked final EnrollmentGroup mockedEnrollmentGroupResponse) throws ProvisioningServiceClientException
    {
        // arrange
        final String enrollmentGroupId = "enrollmentGroupId-1";
        final String enrollmentGroupPath = "enrollmentGroups/" + enrollmentGroupId;
    ...
    @Test
    public void deleteEnrollmentRequestWithEtagSucceed(@Mocked final EnrollmentGroup mockedEnrollmentGroup) throws ProvisioningServiceClientException
    {
        // arrange
        final String enrollmentGroupId = "enrollmentGroupId-1";
        final String eTag = "validETag";
    ...
    /* SRS_ENROLLMENT_GROUP_MANAGER_21_028: [If the enrollmentGroup contains eTag, the delete shall send a Http request with `If-Match` the eTag in the header.] */
    @Test
    public void deleteEnrollmentRequestWithoutEtagSucceed(@Mocked final EnrollmentGroup mockedEnrollmentGroup) throws ProvisioningServiceClientException
    {
        // arrange
        final String enrollmentGroupId = "enrollmentGroupId-1";
        final String enrollmentGroupPath = "enrollmentGroups/" + enrollmentGroupId;
    ...
    @Test(expected = ProvisioningServiceClientTransportException.class)
    public void deleteEnrollmentRequestTransportFailed(@Mocked final EnrollmentGroup mockedEnrollmentGroup) throws ProvisioningServiceClientException
    {
        // arrange
        final String enrollmentGroupId = "enrollmentGroupId-1";
        final String eTag = "validETag";
    ...
    @Test(expected = ProvisioningServiceClientException.class)
    public void deleteEnrollmentServiceReportedFail(@Mocked final EnrollmentGroup mockedEnrollmentGroup) throws ProvisioningServiceClientException
    {
        // arrange
        final String enrollmentGroupId = "enrollmentGroupId-1";
        final String eTag = "validETag";
    ...
    @Test
    public void deleteEnrollmentGroupIdAndETagRequestWithEtagSucceed() throws ProvisioningServiceClientException
    {
        // arrange
        final String enrollmentGroupId = "enrollmentGroupId-1";
        final String eTag = "validETag";
    ...
    /* SRS_ENROLLMENT_GROUP_MANAGER_21_034: [If the eTag is not null or empty, the delete shall send a Http request with `If-Match` the eTag in the header.] */
    @Test
    public void deleteEnrollmentGroupIdAndETagRequestWithNullEtagSucceed() throws ProvisioningServiceClientException
    {
        // arrange
        final String enrollmentGroupId = "enrollmentGroupId-1";
        final String enrollmentGroupPath = "enrollmentGroups/" + enrollmentGroupId;
    ...
    /* SRS_ENROLLMENT_GROUP_MANAGER_21_034: [If the eTag is not null or empty, the delete shall send a Http request with `If-Match` the eTag in the header.] */
    @Test
    public void deleteEnrollmentGroupIdAndETagRequestWithEmptyEtagSucceed() throws ProvisioningServiceClientException
    {
        // arrange
        final String enrollmentGroupId = "enrollmentGroupId-1";
        final String enrollmentGroupPath = "enrollmentGroups/" + enrollmentGroupId;
    ...
    @Test(expected = ProvisioningServiceClientTransportException.class)
    public void deleteEnrollmentGroupIdAndETagRequestTransportFailed() throws ProvisioningServiceClientException
    {
        // arrange
        final String enrollmentGroupId = "enrollmentGroupId-1";
        final String eTag = "validETag";
    ...
    @Test(expected = ProvisioningServiceClientException.class)
    public void deleteEnrollmentGroupIdAndETagRequestServiceReportedFail() throws ProvisioningServiceClientException
    {
        // arrange
        final String enrollmentGroupId = "enrollmentGroupId-1";
        final String eTag = "validETag";
    ...
    public void createQueryThrowsOnNullQuerySpecification()
    {
        ...
        // act
        Deencapsulation.invoke(enrollmentGroupManager, "createQuery", new Class[]{QuerySpecification.class, Integer.class}, null, 0);
    ...
    public void createQueryThrowsOnNegativePageSize(@Mocked final QuerySpecification mockedQuerySpecification)
    {
        ...
        // act
        Deencapsulation.invoke(enrollmentGroupManager, "createQuery", new Class[]{QuerySpecification.class, Integer.class}, mockedQuerySpecification, -10);
    ...
    public void createQuerySucceed(@Mocked final QuerySpecification mockedQuerySpecification, @Mocked final Query mockedQuery)
    {
        ...
        {
            {
                Deencapsulation.newInstance(Query.class, new Class[]{ContractApiHttp.class, String.class, QuerySpecification.class, Integer.class}, mockedContractApiHttp, enrollmentGroupPath, mockedQuerySpecification, 0);
                result = mockedQuery;
                times = 1;
            }
        };
        ...
        // act
        Query query = Deencapsulation.invoke(enrollmentGroupManager, "createQuery", new Class[]{QuerySpecification.class, Integer.class}, mockedQuerySpecification, 0);
