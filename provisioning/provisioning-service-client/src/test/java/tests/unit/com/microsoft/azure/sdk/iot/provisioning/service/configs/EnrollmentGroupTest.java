...
public class EnrollmentGroupTest
{
    ...
    private static final String PRIVATE_KEY_STRING = "-----BEGIN EC PRIVATE KEY-----\n" + "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX\n" + "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX\n" + "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX\n" + "-----END EC PRIVATE KEY-----\n";
    ...
    {
        EnrollmentGroup enrollmentGroup = new EnrollmentGroup(VALID_ENROLLMENT_GROUP_ID, X509Attestation.createFromRootCertificates(PUBLIC_KEY_CERTIFICATE_STRING, null));
    ...
    {
        // arrange
        final String json = "{\n" + "  \"enrollmentGroupId\": \"" + VALID_ENROLLMENT_GROUP_ID + "\",\n" + "  \"attestation\": {\n" + "    \"type\": \"x509\",\n" + "    \"x509\": {\n" + "      \"signingCertificates\": {\n" + "        \"primary\": {" + "          \"certificate\":\"" + PUBLIC_KEY_CERTIFICATE_STRING + "\"\n" + "        }\n" + "      }\n" + "    }\n" + "  },\n" + "  \"iotHubHostName\": \"" + VALID_IOTHUB_HOST_NAME + "\",\n" + "  \"provisioningStatus\": \"enabled\"\n" + "}";
    ...
    public void toJsonElementSimpleEnrollmentWithTwin()
    {
        // arrange
        EnrollmentGroup enrollmentGroup = makeStandardEnrollmentGroup();
        enrollmentGroup.setInitialTwin(new TwinState(new TwinCollection()
        {{
            put("tag1", "valueTag1");
            put("tag2", "valueTag2");
        }}, new TwinCollection()
    ...
    @Test(expected = IllegalArgumentException.class)
    public void setAttestationMechanismThrowsOnTpm(@Mocked final TpmAttestation mockedTpmAttestation, @Mocked final AttestationMechanism mockedAttestationMechanismMechanism)
    {
        // arrange
        EnrollmentGroup enrollmentGroup = makeStandardEnrollmentGroup();
    ...
    /* SRS_ENROLLMENT_GROUP_21_042: [The setAttestation shall throw IllegalArgumentException if the attestation is not X509 signingCertificate.] */
    @Test(expected = IllegalArgumentException.class)
    public void setAttestationMechanismThrowsOnNoSigningCertificate(@Mocked final X509Attestation mockedX509Attestation, @Mocked final AttestationMechanism mockedAttestationMechanismMechanism)
    {
        // arrange
        EnrollmentGroup enrollmentGroup = makeStandardEnrollmentGroup();
    ...
    @Test
    public void setAttestationMechanismSucceed(@Mocked final X509Attestation mockedX509Attestation, @Mocked final X509Certificates mockedX509Certificates, @Mocked final AttestationMechanism mockedAttestationMechanismMechanism)
    {
        // arrange
        EnrollmentGroup enrollmentGroup = makeStandardEnrollmentGroup();
    ...
    @Test(expected = IllegalArgumentException.class)
    public void setAttestationThrowsOnTpm(@Mocked final TpmAttestation mockedTpmAttestation, @Mocked final AttestationMechanism mockedAttestationMechanismMechanism)
    {
        // arrange
        EnrollmentGroup enrollmentGroup = makeStandardEnrollmentGroup();
    ...
    /* SRS_ENROLLMENT_GROUP_21_040: [The setAttestation shall throw IllegalArgumentException if the attestation is not X509 signingCertificate.] */
    @Test(expected = IllegalArgumentException.class)
    public void setAttestationThrowsOnNoSigningCertificate(@Mocked final X509Attestation mockedX509Attestation, @Mocked final AttestationMechanism mockedAttestationMechanismMechanism)
    {
        // arrange
        EnrollmentGroup enrollmentGroup = makeStandardEnrollmentGroup();
    ...
    @Test
    public void setAttestationSucceed(@Mocked final X509Attestation mockedX509Attestation, @Mocked final X509Certificates mockedX509Certificates, @Mocked final AttestationMechanism mockedAttestationMechanismMechanism)
    {
        // arrange
        EnrollmentGroup enrollmentGroup = makeStandardEnrollmentGroup();
    ...
    private final class MockEnrollmentGroup extends EnrollmentGroup
    {
        ...
        MockEnrollmentGroup(String enrollmentGroupId, Attestation attestation)
        {
