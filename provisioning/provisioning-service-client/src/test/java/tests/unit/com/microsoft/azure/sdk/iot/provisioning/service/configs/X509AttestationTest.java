...
public class X509AttestationTest
{
    ...
    public void constructorThrowsOnClientAndRootCertificatesNull()
    {
        ...
        // act
        Deencapsulation.newInstance(X509Attestation.class, new Class[]{X509Certificates.class, X509Certificates.class, X509CAReferences.class}, clientCertificates, rootCertificates, caReferences);
    ...
    @Test(expected = IllegalArgumentException.class)
    public void constructorThrowsOnClientAndRootCertificatesNotNull(@Mocked final X509Certificates mockedX509Certificates)
    {
        // arrange
    ...
    /* SRS_X509_ATTESTATION_21_002: [The constructor shall throw IllegalArgumentException if more than one certificate type are not null.] */
    @Test(expected = IllegalArgumentException.class)
    public void constructorThrowsOnRootCertificatesAndCAReferenceNotNull(@Mocked final X509Certificates mockedX509Certificates, @Mocked final X509CAReferences mockedX509CAReferences)
    {
        // arrange
        X509Certificates clientCertificates = null;
        X509Certificates rootCertificates = mockedX509Certificates;
    ...
    @Test
    public void constructorStoresClientCertificateSucceed(@Mocked final X509Certificates mockedX509Certificates)
    {
        // arrange
        X509Certificates clientCertificates = mockedX509Certificates;
        X509Certificates rootCertificates = null;
        ...
        // act
        X509Attestation x509Attestation = Deencapsulation.newInstance(X509Attestation.class, new Class[]{X509Certificates.class, X509Certificates.class, X509CAReferences.class}, clientCertificates, rootCertificates, caReferences);
    ...
    /* SRS_X509_ATTESTATION_21_003: [The constructor shall store the provided `clientCertificates`, `rootCertificates`, and `caReferences`.] */
    @Test
    public void constructorStoresRootCertificateSucceed(@Mocked final X509Certificates mockedX509Certificates)
    {
        // arrange
        X509Certificates clientCertificates = null;
        X509Certificates rootCertificates = mockedX509Certificates;
    ...
    /* SRS_X509_ATTESTATION_21_003: [The constructor shall store the provided `clientCertificates`, `rootCertificates`, and `caReferences`.] */
    @Test
    public void constructorStoresCAReferenceSucceed(@Mocked final X509CAReferences mockedX509CAReferences)
    {
        // arrange
        X509Certificates clientCertificates = null;
        X509Certificates rootCertificates = null;
    ...
    @Test(expected = IllegalArgumentException.class)
    public void constructorCopiesClientCertificateThrowsOnNull() throws IllegalArgumentException
    {
        // arrange
        // act
    ...
    @Test(expected = IllegalArgumentException.class)
    public void constructorCopiesClientCertificateThrowsOnBothCertsNotNull(@Mocked final X509Certificates mockedX509Certificates)
    {
        // arrange
        X509Attestation x509Attestation = Deencapsulation.newInstance(X509Attestation.class);
    ...
    /* SRS_X509_ATTESTATION_21_006: [The constructor shall throw IllegalArgumentException if more than one certificate type are not null.] */
    @Test(expected = IllegalArgumentException.class)
    public void constructorCopiesClientCertificateThrowsOnBothRootCertificateAndCAReferenceAreNotNull(@Mocked final X509Certificates mockedX509Certificates, @Mocked final X509CAReferences mockedX509CAReferences)
    {
        // arrange
        X509Attestation x509Attestation = Deencapsulation.newInstance(X509Attestation.class);
    ...
    @Test
    public void constructorCopiesClientCertificateSucceed(@Mocked final X509Certificates mockedX509Certificates)
    {
        // arrange
        X509Certificates clientCertificates = mockedX509Certificates;
        X509Certificates rootCertificates = null;
    ...
    /* SRS_X509_ATTESTATION_21_007: [The constructor shall copy `clientCertificates`, `rootCertificates`, and `caReferences` from the provided X509Attestation.] */
    @Test
    public void constructorCopiesRootCertificateSucceed(@Mocked final X509Certificates mockedX509Certificates)
    {
        // arrange
        X509Certificates clientCertificates = null;
        X509Certificates rootCertificates = mockedX509Certificates;
    ...
    /* SRS_X509_ATTESTATION_21_007: [The constructor shall copy `clientCertificates`, `rootCertificates`, and `caReferences` from the provided X509Attestation.] */
    @Test
    public void constructorCopiesCAReferencesSucceed(@Mocked final X509CAReferences mockedX509CAReferences)
    {
        // arrange
        X509Certificates clientCertificates = null;
        X509Certificates rootCertificates = null;
    ...
    @Test
    public void factoryCreatesX509AttestationForClientCertificateOnlyPrimarySucceed(@Mocked final X509Certificates mockedX509Certificates)
    {
        // arrange
    ...
    @Test
    public void factoryCreatesX509AttestationForClientCertificateSucceed(@Mocked final X509Certificates mockedX509Certificates)
    {
        // arrange
        new NonStrictExpectations()
        {
    ...
    @Test
    public void factoryCreatesX509AttestationForSigningCertificateOnlyPrimarySucceed(@Mocked final X509Certificates mockedX509Certificates)
    {
        // arrange
        new NonStrictExpectations()
        {
    ...
    @Test
    public void factoryCreatesX509AttestationForRootCertificatesucceed(@Mocked final X509Certificates mockedX509Certificates)
    {
        // arrange
        new NonStrictExpectations()
        {
    ...
    @Test
    public void factoryCreatesX509AttestationForCAReferenceOnlyPrimarySucceed(@Mocked final X509CAReferences mockedX509CAReferences)
    {
        // arrange
        new NonStrictExpectations()
        {
    ...
    @Test
    public void factoryCreatesX509AttestationForCAReferencesSucceed(@Mocked final X509CAReferences mockedX509CAReferences)
    {
        // arrange
        new NonStrictExpectations()
        {
    ...
    @Test
    public void getterForRootCertificateSucceed(@Mocked final X509Certificates mockedX509Certificates)
    {
        // arrange
        X509Attestation x509Attestation = X509Attestation.createFromRootCertificates(PUBLIC_CERTIFICATE_STRING, PUBLIC_CERTIFICATE_STRING);
    ...
    @Test
    public void getterForCAReferencesSucceed(@Mocked final X509Certificates mockedX509Certificates)
    {
        // arrange
    ...
    @Test
    public void getterForClientCertificatesPrimaryInfoSucceed(@Mocked final X509Certificates mockedX509Certificates, @Mocked final X509CertificateWithInfo mockedX509CertificateWithInfo, @Mocked final X509CertificateInfo mockedX509CertificateInfo)
    {
        // arrange
    ...
    @Test
    public void getterForRootCertificatesPrimaryInfoSucceed(@Mocked final X509Certificates mockedX509Certificates, @Mocked final X509CertificateWithInfo mockedX509CertificateWithInfo, @Mocked final X509CertificateInfo mockedX509CertificateInfo)
    {
        // arrange
    ...
    @Test
    public void getterForClientCertificatesSecondaryInfoSucceed(@Mocked final X509Certificates mockedX509Certificates, @Mocked final X509CertificateWithInfo mockedX509CertificateWithInfo, @Mocked final X509CertificateInfo mockedX509CertificateInfo)
    {
        // arrange
        final X509Certificates clientCertificates = mockedX509Certificates;
        final X509Certificates rootCertificates = null;
    ...
    /* SRS_X509_ATTESTATION_21_021: [If the clientCertificates is not null, and it contains secondary key, the getSecondaryX509CertificateInfo shall return the info in the secondary key of the rootCertificates.] */
    @Test
    public void getterForClientCertificatesSecondaryInfoSucceedOnNullSecondaryCertificate(@Mocked final X509Certificates mockedX509Certificates)
    {
        // arrange
        final X509Certificates clientCertificates = mockedX509Certificates;
        final X509Certificates rootCertificates = null;
    ...
    @Test
    public void getterForRootCertificatesSecondaryInfoSucceed(@Mocked final X509Certificates mockedX509Certificates, @Mocked final X509CertificateWithInfo mockedX509CertificateWithInfo, @Mocked final X509CertificateInfo mockedX509CertificateInfo)
    {
        // arrange
        final X509Certificates clientCertificates = null;
        final X509Certificates rootCertificates = mockedX509Certificates;
    ...
    /* SRS_X509_ATTESTATION_21_022: [If the rootCertificates is not null, and it contains secondary key, the getSecondaryX509CertificateInfo shall return the info in the secondary key of the rootCertificates.] */
    @Test
    public void getterForRootCertificatesSecondaryInfoSucceedOnNullSecondaryCertificate(@Mocked final X509Certificates mockedX509Certificates)
    {
        // arrange
        final X509Certificates clientCertificates = null;
        final X509Certificates rootCertificates = mockedX509Certificates;
