...
public class IndividualEnrollmentTest
{
    ...
    {
        IndividualEnrollment individualEnrollment = new IndividualEnrollment(VALID_REGISTRATION_ID, new TpmAttestation(VALID_ENDORSEMENT_KEY, VALID_STORAGE_ROOT_KEY));
    ...
    @Test
    public void constructorWithJsonSetsInitialTwinUsesSetters(@Mocked final TwinState mockedTwinState)
    {
        // arrange
    ...
    public void toJsonElementSimpleEnrollmentWithTwin()
    {
        // arrange
        IndividualEnrollment individualEnrollment = makeStandardEnrollment();
        individualEnrollment.setInitialTwin(new TwinState(new TwinCollection()
        {{
            put("tag1", "valueTag1");
            put("tag2", "valueTag2");
        }}, new TwinCollection()
    ...
    @Test
    public void setAttestationMechanismSucceed(@Mocked final TpmAttestation mockedTpmAttestation, @Mocked final AttestationMechanism mockedAttestationMechanism)
    {
        // arrange
        IndividualEnrollment individualEnrollment = makeStandardEnrollment();
    ...
    @Test
    public void setAttestationSucceed(@Mocked final TpmAttestation mockedTpmAttestation, @Mocked final AttestationMechanism mockedAttestationMechanism)
    {
        // arrange
        IndividualEnrollment individualEnrollment = makeStandardEnrollment();
    ...
    private final class MockIndividualEnrollment extends IndividualEnrollment
    {
        ...
        MockIndividualEnrollment(String registrationId, Attestation attestation)
        {
